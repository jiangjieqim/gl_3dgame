...
//http://learnopengl-cn.readthedocs.io/zh/latest/01%20Getting%20started/04%20Hello%20Triangle/
...
const GLfloat vertices[] = {  
	1.0f,0.0f,	-0.5f,	-0.5f,	0.0f,		1.0f,			-0.5f,	-0.5f,	0.0f,		
	0.0f,1.0f,	-0.5f,	-0.5f,	0.0f,		1.0f,			0.5f,	-0.5f,	0.0f,		  
	0.0f,0.0f,	-0.5f,	-0.5f,	0.0f,		1.0f,			0.5f,	0.5f,	0.0f
	//		-0.5f,0.5f,0.0f,1.0f,  
};  
...
{  
	...
	//解释顶点数据方式  
	glVertexAttribPointer(0, span, GL_FLOAT, GL_FALSE, 0, 0); 

	//绘制模型  
	//glDrawArrays(GL_TRIANGLE_FAN, 0, 4);

	//顶点的个数
	int vert_count = sizeof(vertices) / sizeof(float) / span;//3
